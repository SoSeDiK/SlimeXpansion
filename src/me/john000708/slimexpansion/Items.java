...
public class Items {
    ...
    public static ItemStack DEEP_DEPTH_MINER = new CustomItem(new ItemStack(Material.DIAMOND_BLOCK), "&4Глубокий ядерный копатель", "", "&fИзвлекает руды прямо из &8бедрока&f", "", "Может добывать редкий радиоактивный &2торий", "", MachineTier.END_GAME.and(MachineType.MACHINE), "&8\u21E8 &e\u26A1 &71024 Дж/с", "&8\u21E8 &7Требует &cлазерный заряд &fдля работы");
